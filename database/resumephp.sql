...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=416987693ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=resumephp&table=users">`resumephp`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=resumephp&table=jobs">`resumephp`.`jobs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=resumephp&table=techstack">`resumephp`.`techstack`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=resumephp&table=Users">`resumephp`.`Users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=students&table=studentslist">`students`.`studentslist`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=students&table=studentsList">`students`.`studentsList`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce&table=product">`ecommerce`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce&table=orderproduct">`ecommerce`.`orderproduct`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce&table=orderdetails">`ecommerce`.`orderdetails`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce&table=category">`ecommerce`.`category`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5c4c29765625246e53792177486b466b">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="resumephp" targettable="jobs">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `jobs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="resumephp" targettable="jobs">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `jobs`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="resumephp" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
